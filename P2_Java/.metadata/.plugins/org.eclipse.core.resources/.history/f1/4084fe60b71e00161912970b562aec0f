...
public class LevelScreen2GameState extends BasicGameState {
	...
	public void mouseClicked(int button, int x, int y, int clickCount) {
	    	if (x > 550 && x < 550 + 80
			&& y > 300 && y < 380) { //Lvl1
		    game.enterState(111); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 750 && x < 750 + 80
			&& y > 300 && y < 380) { //Lvl2
		    game.enterState(112); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 950 && x < 950 + 80
			&& y > 300 && y < 380) { //Lvl3
		    game.enterState(113); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 1150 && x < 1150 + 80
			&& y > 300 && y < 380) { //Lvl4
		    game.enterState(114); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 1350 && x < 1350 + 80
			&& y > 300 && y < 380) { //Lvl5
		    game.enterState(115); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 550 && x < 550 + 80
			&& y > 480 && y < 560) { //Lvl6
		    game.enterState(116); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 750 && x < 750 + 80
	    		&& y > 480 && y < 560) { //Lvl7
		    game.enterState(117); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 950 && x < 950 + 80
	    		&& y > 480 && y < 560) { //Lvl8
		    game.enterState(118); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 1150 && x < 1150 + 80
	    		&& y > 480 && y < 560) { //Lvl9
		    game.enterState(119); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 1350 && x < 1350 + 80
	    		&& y > 480 && y < 560) { //Lvl10
		    game.enterState(120); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	
	    	if (x > 550 && x < 550 + 400
			&& y > 750 && y < 750+80) { //Page1DesNiveaux
		    game.enterState(11); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
