...
public class LevelScreen1GameState extends BasicGameState {
	...
	public void mouseClicked(int button, int x, int y, int clickCount) {
	    	if (x > 550 && x < 550 + 80
			&& y > 300 && y < 380) { //Lvl1
		    game.enterState(101); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 750 && x < 750 + 80
			&& y > 300 && y < 380) { //Lvl2
		    game.enterState(102); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 950 && x < 950 + 80
			&& y > 300 && y < 380) { //Lvl3
		    game.enterState(103); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 1150 && x < 1150 + 80
			&& y > 300 && y < 380) { //Lvl4
		    game.enterState(104); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 1350 && x < 1350 + 80
			&& y > 300 && y < 380) { //Lvl5
		    game.enterState(105); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 550 && x < 550 + 80
			&& y > 480 && y < 560) { //Lvl6
		    game.enterState(106); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 750 && x < 750 + 80
	    		&& y > 480 && y < 560) { //Lvl7
		    game.enterState(107); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 950 && x < 950 + 80
	    		&& y > 480 && y < 560) { //Lvl8
		    game.enterState(108); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 1150 && x < 1150 + 80
	    		&& y > 480 && y < 560) { //Lvl9
		    game.enterState(109); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
	    	if (x > 1350 && x < 1350 + 80
	    		&& y > 480 && y < 560) { //Lvl10
		    game.enterState(110); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
		    ...
		    game.enterState(12); // Il faudrait mettre les ID correspodnant au niveau
		    			// ou appeler la fonction lvl avec le string du nom du lvl
		}
