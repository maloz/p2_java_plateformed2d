...
public class Player extends Character {
    ...
    private LanceGrenade lanceGrenade;
    private int point;
    private boolean key;
    private Sound jump;
	...
	lanceGrenade = new LanceGrenade(0, 0, 1000);
	...
	lanceGrenade.setPlayerFacing(this.facing);
    }
    ...
    public void shootGrenade(int mouseX, int mouseY) throws SlickException {
	lanceGrenade.shoot(x, y, mouseX, mouseY);
	this.facing = lanceGrenade.getWay();
	lanceGrenade.setPlayerFacing(this.facing);
    }
    ...
    public LanceGrenade getLanceGrenade()
    {
	return lanceGrenade;
    }
